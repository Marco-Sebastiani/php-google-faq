...
<body>
    <header>
        <div class="header-top">
            <div class="box-logo">
                <a href="#"><img src="img/googlelogo.svg" alt="googlelogo"></a>
        ...
        <div class="header-bottom">
            <ul class="flex">
                ...
                <li>
                    <a class="blue" href="#">Domande frequenti</a>
                </li>
